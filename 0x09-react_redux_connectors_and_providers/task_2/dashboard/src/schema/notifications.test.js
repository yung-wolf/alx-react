...
import { getAllNotificationsByUser, user, message, notification, normalizedData } from './notifications';


describe('getAllNotificationsByUser', () => {
  test('returns the correct notifications for user id 5debd764a7c57c7839d722e9', () => {
